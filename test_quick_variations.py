#!/usr/bin/env python3
"""
Quick test for org code variations
"""

import requests
import json

def test_quick_variations():
    """Test quick variations of the org code"""
    print("🔍 Testing Quick Org Code Variations")
    print("="*60)
...
def main():
    """Main function"""
    print("🚀 **QUICK ORG CODE VARIATIONS TESTER**")
    print("="*60)
    print("🔍 Testing quick variations of the org code...")
    
    # Test org variations
    valid_orgs = test_quick_variations()
