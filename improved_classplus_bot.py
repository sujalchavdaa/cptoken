#!/usr/bin/env python3
"""
Improved Classplus Bot using extracted patterns
"""
...
class ImprovedClassplusBot:
    ...
    def test_real_org_code(self, org_code, email):
        ...
        print(f"🚀 **TESTING WITH EXTRACTED PATTERNS**")
        print("="*60)
...
def main():
    ...
    # Test with real data
    org_code = input("📝 Enter org code to test: ").strip()
    ...
    if org_code:
        ...
        if org_id and session_id:
            ...
            if otp:
                ...
                user_token = bot.verify_otp_and_get_user_token(session_id, otp, org_id, email)
                ...
                if user_token:
                    ...
                    # Decode token
                    bot.decode_user_token(user_token)
                else:
